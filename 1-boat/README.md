...
<img src="https://github.com/jmtritch/COSMOS22-Cluster13/blob/boat-branch/1-boat/boat-team-images/fc-sik-radio.jpg" width="200" height="200" />
...
<img src="https://github.com/jmtritch/COSMOS22-Cluster13/blob/boat-branch/1-boat/boat-team-images/gps-internals.jpg" width="200" height="200" />
...
<img src="https://github.com/jmtritch/COSMOS22-Cluster13/blob/boat-branch/1-boat/boat-team-images/pairing-radio.jpg" width="200" height="200"/>
...
* ![Cluster 13 students ready for the first test](https://github.com/jmtritch/COSMOS22-Cluster13/blob/boat-branch/1-boat/boat-team-images/first-test-day.jpg)
* ![Driving the boat around with the buoy](https://github.com/jmtritch/COSMOS22-Cluster13/blob/boat-branch/1-boat/boat-team-images/lake-day.jpg)
...
* ![New 3D-printed propellers](https://github.com/jmtritch/COSMOS22-Cluster13/blob/boat-branch/1-boat/boat-team-images/3dp-propellers.jpg)
* ![Broken propellers] (https://github.com/jmtritch/COSMOS22-Cluster13/blob/boat-branch/1-boat/boat-team-images/broken-propellers.jpg)
...
* In our second pool test, we tested our new steering system, which worked better than we expected, allowing us to make very tight turns and easily maneuver within the skinny pool lane we had access to. This was a result of two modifications to the original steering system:
    * Reorienting the servo to accommodate a longer custom 3D printed lever arm 
        ...
        * ![Servo Mod](https://github.com/jmtritch/COSMOS22-Cluster13/blob/boat-branch/1-boat/boat-team-images/servo-mod.jpg)
...
* ![3D-printed rudder installed](https://github.com/jmtritch/COSMOS22-Cluster13/blob/boat-branch/1-boat/boat-team-images/rudder-mod.jpg)
...
* ![First test with the PixHawk](https://github.com/jmtritch/COSMOS22-Cluster13/blob/boat-branch/1-boat/boat-team-images/first-pixhawk-test.jpg)
...
* ![Getting the boat ready for lake day](https://github.com/jmtritch/COSMOS22-Cluster13/blob/boat-branch/1-boat/boat-team-images/lake-day.jpg)
